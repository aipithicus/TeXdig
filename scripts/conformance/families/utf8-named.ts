...
export const UTF8_NAMED_INPUTS: readonly Uint8Array[] = Object.freeze([
  ...
  Uint8Array.of(0xe2, 0x82, 0xac),
  Uint8Array.of(0xf0, 0x9f, 0x98, 0x80),
  Uint8Array.of(0x7f, 0xdf, 0xbf, 0xef, 0xbf, 0xbf, 0xf4, 0x8f, 0xbf, 0xbf),
  Uint8Array.of(0xef, 0xbb, 0xbf, 0x41),
  Uint8Array.of(0x41, 0xef, 0xbb, 0xbf),
  Uint8Array.of(0x80),
